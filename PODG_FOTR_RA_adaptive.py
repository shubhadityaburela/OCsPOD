...
impath = args.dir_prefix + "/data/PODG_FOTR_RA_adaptive/" + common_basis + "/" + "problem=" + str(
    problem) + "/" + TYPE + "=" + str(VAL) + "/"  # for data
immpath = args.dir_prefix + "/plots/PODG_FOTR_RA_adaptive/" + common_basis + "/" + "problem=" + str(
