...
for opt_step in range(kwargs['opt_iter']):
    ...
    # val = 0
    # plt.plot(as_adj[0, val:], label="1")
    # plt.savefig('as_adj_1.png', bbox_inches='tight')
    # plt.plot(as_adj[1, val:], label="2")
    # plt.savefig('as_adj_2.png', bbox_inches='tight')
    # plt.plot(as_adj[2, val:], label="3")
    # plt.savefig('as_adj_3.png', bbox_inches='tight')
    # plt.plot(as_adj[3, val:], label="4")
    # plt.savefig('as_adj_4.png', bbox_inches='tight')
    # plt.plot(as_adj[4, val:], label="5")
    # plt.savefig('as_adj_5.png', bbox_inches='tight')
    # plt.plot(as_adj[5, val:], label="6")
    # plt.savefig('as_adj_6.png', bbox_inches='tight')
    # plt.plot(as_adj[6, val:], label="7")
    # plt.savefig('as_adj_7.png', bbox_inches='tight')
    #
    # # print(as_adj[0, :20])
    # # print(as_adj[1, :20])
    # # print(as_adj[2, :20])
