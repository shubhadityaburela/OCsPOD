...
def Update_Control_PODG_FOTR_RA_BB(fOld, fNew, dL_du_Old, dL_du_New, itr, **kwargs):  # Barzilai Borwein
...
def Update_Control_sPODG_FOTR_RA_BB(fOld, fNew, dL_du_Old, dL_du_New, itr, **kwargs):  # Barzilai Borwein
