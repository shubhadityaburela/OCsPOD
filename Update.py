...
def Update_Control_TWBT(f, q0, qs_target, mask, A_p, J_s_prev, omega_prev, dL_du_s, C, adjust, **kwargs):  # Two-way back tracking
    ...
    J_s, _ = Calc_Cost(qs, qs_target, f, C, kwargs['dx'], kwargs['dt'], kwargs['lamda_l1'], kwargs['lamda_l2'], adjust)
