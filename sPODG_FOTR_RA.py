...
impath = args.dir_prefix + "/data/sPODG_FOTR_RA/" + common_basis + "/" + interp_scheme + "/" + "problem=" + str(
    problem) + "/" + TYPE + "=" + str(VAL) + "/"  # for data
immpath = args.dir_prefix + "/plots/sPODG_FOTR_RA/" + common_basis + "/" + interp_scheme + "/" + "problem=" + str(
