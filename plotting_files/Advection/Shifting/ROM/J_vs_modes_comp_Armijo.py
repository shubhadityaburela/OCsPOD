...
if problem == "Shifting":
    impath = "../../../Plots/results_advection_Armijo/Shifting/ROM/"
    os.makedirs(impath, exist_ok=True)
else:
    impath = "../../../Plots/results_advection_Armijo/Shifting_3/ROM/"
    os.makedirs(impath, exist_ok=True)
...
def extract(problem, ROM_framework, file1=None, file2=None):
    base_path = "/Users/shubhadityaburela/Python/Paper(4.1 + 4.2)_OCsPOD/OCsPOD/results_advection_Armijo/data/" + problem + "/" + ROM_framework + "/L1=0.0_L2=0.001/"
