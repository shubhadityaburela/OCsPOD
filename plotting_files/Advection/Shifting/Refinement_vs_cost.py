...
def extract(problem, ROM_framework, type_of_basis, modes, file1=None, file2=None):
    base_path = "/Users/shubhadityaburela/Python/Paper(4.1 + 4.2)_OCsPOD/OCsPOD/results_advection_FOTR_other/data/" + problem + "/" + ROM_framework + "/" + type_of_basis + "/L1=0.0_L2=0.001/modes=[" + str(modes) + ", " + str(modes) + "]/"
