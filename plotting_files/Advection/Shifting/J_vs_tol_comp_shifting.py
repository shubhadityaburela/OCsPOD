...
def extract_data(sorted_paths: List[str],
    ...
    for root in sorted_paths:
        ...
        top_f32 = rootp / file3[0][1]

        if top_f1.exists() and top_f2.exists() and top_f31.exists() and top_f32.exists():
            f1_path = top_f1
            f2_path = top_f2
            f31_path = top_f31
            f32_path = top_f32
        ...
        try:
            ...
            warnings.warn(f"Failed to load {f32_path!s}: {e}", RuntimeWarning)
            continue
