...
if problem == "Shifting":
    FOM_control = np.load(
        "/Users/shubhadityaburela/Python/Paper(4.1 + 4.2)_OCsPOD/OCsPOD/results_advection_FOTR/data/Shifting/FOM/L1=0.0_L2=0.001/n_c=41/last_valid_control_final.npy",
        allow_pickle=True)
else:
    FOM_control = np.load(
        "/Users/shubhadityaburela/Python/Paper(4.1 + 4.2)_OCsPOD/OCsPOD/results_advection_FOTR/data/Shifting_3/FOM/L1=0.0_L2=0.001/n_c=41/last_valid_control_final.npy",
        allow_pickle=True)
...
save_fig(impath + 'Results_fotr' + problem, fig)