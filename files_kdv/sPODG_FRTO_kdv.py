...
from grid_params import Korteweg_de_Vries_Burgers, Korteweg_de_Vries
...
from sPODG_solver import (
    IC_primal_sPODG_FRTO_kdv,
    IC_adjoint_sPODG_FRTO_kdv, mat_primal_sPODG_FRTO_kdv, TI_primal_sPODG_FRTO_kdv_expl, TI_adjoint_sPODG_FRTO_kdv_impl,
)
...
def build_dirs(prefix, fully_nonlinear, common_basis, reg_tuple, CTC_mask, TYPE, VAL):
    ...
    data_dir = os.path.join(prefix, "data/sPODG_FRTO_kdv", fnl_str, cb_str, reg_str, f"CTC_mask={CTC_mask}",
                            f"{TYPE}={VAL}")
    plot_dir = os.path.join(prefix, "plots/sPODG_FRTO_kdv", fnl_str, cb_str, reg_str, f"CTC_mask={CTC_mask}",
                            f"{TYPE}={VAL}")
