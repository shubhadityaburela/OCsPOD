...
from PODG_solver import IC_adjoint_PODG_FOTR_kdv, \
    mat_adjoint_PODG_FOTR_kdv_mix, TI_adjoint_PODG_FOTR_kdv_expl_mix
...
from sPODG_solver import (
    IC_primal_sPODG_FOTR_kdv, mat_primal_sPODG_FOTR_kdv, TI_primal_sPODG_FOTR_kdv_expl,
)
...
def build_dirs(prefix, fully_nonlinear, common_basis, reg_tuple, CTC_mask, TYPE, VAL):
    ...
    data_dir = os.path.join(prefix, "data/sPODG_PODG_kdv", fnl_str, cb_str, reg_str, f"CTC_mask={CTC_mask}",
                            f"{TYPE}={VAL}")
    plot_dir = os.path.join(prefix, "plots/sPODG_PODG_kdv", fnl_str, cb_str, reg_str, f"CTC_mask={CTC_mask}",
                            f"{TYPE}={VAL}")
