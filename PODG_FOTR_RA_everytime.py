...
impath = args.dir_prefix + "/data/PODG_FOTR_RA_everytime/" + conv_crit + "/" + tar_for_bas + "/" + "problem=" + str(
    problem) + "/" + TYPE + "=" + str(VAL) + "/"  # for data
immpath = args.dir_prefix + "/plots/PODG_FOTR_RA_everytime/" + conv_crit + "/" + tar_for_bas + "/" + "problem=" + str(
