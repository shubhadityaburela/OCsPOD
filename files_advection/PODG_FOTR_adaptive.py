...
def build_dirs(prefix, type_of_problem, common_basis, reg_tuple, TYPE, VAL):
    ...
    data_dir = os.path.join(prefix, "data", type_of_problem, "PODG_FOTR_adaptive", cb_str, reg_str,
                            f"{TYPE}={VAL}")
    plot_dir = os.path.join(prefix, "plots", type_of_problem, "PODG_FOTR_adaptive", cb_str, reg_str,
                            f"{TYPE}={VAL}")
